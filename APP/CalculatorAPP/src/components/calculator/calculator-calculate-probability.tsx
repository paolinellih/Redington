...
const CalculatorCalculateProbability: React.FC = () => {
    const [type, setType] = useState<string>("Select a type");
    ...
    const validateField = (field: keyof CalculateProbabilityRequest, value: any) => {
        ...
        if (field === 'a' || field === 'b') {
            ...
            if (isNaN(numValue) || numValue < 0 || numValue > 1) {
                error =  `Probability  ${field.toLocaleUpperCase()} must be between 0 and 1.`;
            }
        }

        if (field === 'type' && (!value || value === 'Select a type')) {
        ...
        <div style={{padding: "20px", maxWidth: "400px", margin: "0 auto"}}>
            ...
            <form onSubmit={handleSubmit} aria-label="Probability Form">
                ...
                <div className="form-floating mb-3">
                    ...
                    >
                        <option value="Select a type" disabled>
                            Select a type
                        </option>
                        {Array.isArray(types) &&
